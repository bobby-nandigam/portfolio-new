...
const experiences = [
  {
    ...
    highlights: [
      ...
      "Diagnosed and resolved production issues — slow queries, thread blocking, API bottlenecks",
      ...
      "Refactored request-response pipelines reducing payload overhead by 35%",
